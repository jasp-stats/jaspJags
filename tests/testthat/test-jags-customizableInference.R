...
test_that("Model 1: Inference for mu table results match", {
  ...
  jaspTools::expect_equal_tables(table,
                                 list(0.133602335511261, 0.138283372282693, 0.251645058422332, 0.640660111794534,
                                      ...
                                      -0.0142506827661663, 0.319350253685573, 0.612496638532025, -0.648908825457367,
                                      ...
                                      -0.335829822221644, 0.198588475451556, 0.0525307652862037, -0.735115370473834,
                                      ...
                                      -0.353550929288139, 0.245358918840455, 0.127933783390494, -0.843973868269679,
                                      ...
                                      -0.38515229155482, 0.216228053656646, 0.0342138255162074, -0.812154141624535,
...
test_that("Model 2: Inference for mu table results match", {
  table <- results[["results"]][["mainContainer"]][["collection"]][["mainContainer_customInferencemu"]][["collection"]][["mainContainer_customInferencemu_customTable"]][["data"]]
  jaspTools::expect_equal_tables(table,
                                 list(0.942833386190196, 0.865251214181487, 0.743695274837535, 2.1133072882071,
                                      ...
                                      1.00431258109361, -0.48722247815009, -0.473767975859069, 0.550812789765542,
                                      ...
                                      -0.525050218692258, -0.504340179329926, 0.539163034110664, 0.655779275858269,
                                      ...
                                      -0.562193885899904, -0.548664118026812, 0.557911167937291, 0.613701803787932,
                                      ...
                                      -0.920336956274568, 0.61566136598295, 0.419995715668148, -2.01879244077542,
                                      0.597, 0.331689388811898, -2.05265118826821, 1016, "mu<unicode>",
                                      1.0291040678345, 1.00923889301844, -1.33887953546541, -1.24259036188083,
